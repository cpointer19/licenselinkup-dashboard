  ...
  return (
    <div className="flex items-center gap-1.5">
      ...
      <div className="relative">
        ...
        {showTip && (
          <div className="absolute right-0 top-full mt-2 z-50 w-72 rounded-lg border border-slate-200 bg-white p-3 shadow-lg text-xs text-slate-600 leading-relaxed">
